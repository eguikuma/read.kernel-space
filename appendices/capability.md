---
layout: default
title: なぜrootでなくても特権操作ができるのか
---

# [なぜrootでなくても特権操作ができるのか](#why-non-root-can-do-privileged-ops) {#why-non-root-can-do-privileged-ops}

## [はじめに](#introduction) {#introduction}

[04-process-management](../../04-process-management/) の「プロセスの資格情報」で、プロセスには UID や GID 以外に<strong>ケーパビリティ</strong>という情報があることを学びました
...
- [ケーパビリティとは](#what-is-capability)
- [主要なケーパビリティ](#main-capabilities)
- [ケーパビリティの確認方法](#checking-capabilities)
- [ケーパビリティの設定方法](#setting-capabilities)
- [コンテナとケーパビリティ](#container-and-capability)
- [まとめ](#summary)
- [参考資料](#references)

---

## [ケーパビリティとは](#what-is-capability) {#what-is-capability}

### [従来の権限モデルの問題](#traditional-permission-model-problem) {#traditional-permission-model-problem}
...
### [ケーパビリティによる解決](#solution-by-capability) {#solution-by-capability}
...
### [ケーパビリティの効果](#capability-effect) {#capability-effect}
...
## [主要なケーパビリティ](#main-capabilities) {#main-capabilities}

### [よく使われるケーパビリティ](#commonly-used-capabilities) {#commonly-used-capabilities}
...
### [CAP_SYS_ADMIN の特別さ](#cap-sys-admin-special) {#cap-sys-admin-special}
...
## [ケーパビリティの確認方法](#checking-capabilities) {#checking-capabilities}

### [プロセスのケーパビリティを確認](#checking-process-capabilities) {#checking-process-capabilities}
...
### [フィールドの意味](#field-meaning) {#field-meaning}
...
### [16進数をデコード](#decoding-hex) {#decoding-hex}
...
### [実行ファイルのケーパビリティを確認](#checking-executable-capabilities) {#checking-executable-capabilities}
...
## [ケーパビリティの設定方法](#setting-capabilities) {#setting-capabilities}

### [実行ファイルにケーパビリティを設定](#setting-executable-capabilities) {#setting-executable-capabilities}
...
### [ケーパビリティのフラグ](#capability-flags) {#capability-flags}
...
### [設定の削除](#removing-settings) {#removing-settings}

```bash
sudo setcap -r /usr/local/bin/myapp
```

### [capsh でシェルを起動](#launching-shell-with-capsh) {#launching-shell-with-capsh}
...
### [実用例：Node.js で 80 番ポートを開く](#practical-example-nodejs-port-80) {#practical-example-nodejs-port-80}
...
## [コンテナとケーパビリティ](#container-and-capability) {#container-and-capability}

### [コンテナのセキュリティ](#container-security) {#container-security}

Docker などのコンテナランタイムは、ケーパビリティを積極的に利用しています

コンテナはデフォルトで<strong>必要最小限のケーパビリティ</strong>だけを持ちます

### [Docker のデフォルトケーパビリティ](#docker-default-capabilities) {#docker-default-capabilities}
...
### [ケーパビリティの追加・削除](#adding-removing-capabilities) {#adding-removing-capabilities}
...
詳細は [06-namespace](../../06-namespace/) を参照してください
...
- [capabilities(7) - Linux manual page](https://man7.org/linux/man-pages/man7/capabilities.7.html){:target="\_blank"}
  - ケーパビリティの詳細
- [getcap(8) - Linux manual page](https://man7.org/linux/man-pages/man8/getcap.8.html){:target="\_blank"}
  - ファイルのケーパビリティ確認
- [setcap(8) - Linux manual page](https://man7.org/linux/man-pages/man8/setcap.8.html){:target="\_blank"}
  - ファイルのケーパビリティ設定
- [capsh(1) - Linux manual page](https://man7.org/linux/man-pages/man1/capsh.1.html){:target="\_blank"}
  - ケーパビリティのシェルラッパー

<strong>本編との関連</strong>

- [04-process-management](../../04-process-management/)
  - プロセスの資格情報
