---
layout: default
title: ロードアベレージは何を表しているのか
---

# [ロードアベレージは何を表しているのか](#what-load-average-represents) {#what-load-average-represents}

## [はじめに](#introduction) {#introduction}

[01-kernel](../../01-kernel/) の「sysinfo() システムコール」で、<strong>ロードアベレージ</strong>という値が登場しました
...
- [ロードアベレージとは](#what-is-load-average)
- [3つの値の意味](#meaning-of-three-values)
- [何がカウントされるのか](#what-is-counted)
- [CPUコア数との関係](#relationship-with-cpu-cores)
...
## [ロードアベレージとは](#what-is-load-average) {#what-is-load-average}

### [基本的な定義](#basic-definition) {#basic-definition}
...
## [3つの値の意味](#meaning-of-three-values) {#meaning-of-three-values}

### [1分、5分、15分](#one-five-fifteen-minutes) {#one-five-fifteen-minutes}
...
### [傾向の読み取り](#reading-trends) {#reading-trends}
...
### [指数移動平均](#exponential-moving-average) {#exponential-moving-average}
...
## [何がカウントされるのか](#what-is-counted) {#what-is-counted}

### [カウント対象](#count-targets) {#count-targets}
...
### [D状態が含まれる理由](#why-d-state-included) {#why-d-state-included}
...
### [Linux 特有の動作](#linux-specific-behavior) {#linux-specific-behavior}
...
## [CPUコア数との関係](#relationship-with-cpu-cores) {#relationship-with-cpu-cores}

### [基本的な目安](#basic-guideline) {#basic-guideline}
...
### [目安の解釈](#interpreting-guideline) {#interpreting-guideline}
...
### [単純な比率では不十分](#ratio-not-sufficient) {#ratio-not-sufficient}
...
## [よくある誤解](#common-misconceptions) {#common-misconceptions}

### [誤解1：CPU使用率と同じ](#misconception-1-cpu-usage) {#misconception-1-cpu-usage}
...
### [誤解2：低ければ良い](#misconception-2-low-is-good) {#misconception-2-low-is-good}
...
### [誤解3：高ければ必ず問題](#misconception-3-high-is-problem) {#misconception-3-high-is-problem}
...
### [uptime コマンド](#uptime-command) {#uptime-command}
...
### [原因の調査](#investigating-causes) {#investigating-causes}
...
- [uptime(1) - Linux manual page](https://man7.org/linux/man-pages/man1/uptime.1.html){:target="\_blank"}
  - uptime コマンド
...
- [05-scheduler](../../05-scheduler/)
  - スケジューリングと R 状態
- [appendices/process-state.md](../process-state/)
