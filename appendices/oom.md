---
layout: default
title: メモリ不足でプロセスが殺されるのはなぜか
---

# [メモリ不足でプロセスが殺されるのはなぜか](#why-process-killed-on-oom) {#why-process-killed-on-oom}
...
- [OOM Killerとは](#what-is-oom-killer)
- [なぜOOM Killerが必要か](#why-oom-killer-needed)
- [どのプロセスが殺されるか](#which-process-killed)
- [OOM Killerの確認方法](#checking-oom-killer)
- [対策方法](#countermeasures)
- [cgroupとOOM](#cgroup-and-oom)
- [まとめ](#summary)
- [参考資料](#references)

---

## [OOM Killerとは](#what-is-oom-killer) {#what-is-oom-killer}
...
## [なぜOOM Killerが必要か](#why-oom-killer-needed) {#why-oom-killer-needed}

### [Overcommit とは](#what-is-overcommit) {#what-is-overcommit}
...
### [なぜOvercommitを許可するのか](#why-allow-overcommit) {#why-allow-overcommit}
...
### [Overcommitの問題](#overcommit-problems) {#overcommit-problems}
...
### [Overcommitの設定](#overcommit-settings) {#overcommit-settings}
...
## [どのプロセスが殺されるか](#which-process-killed) {#which-process-killed}

### [OOM Score](#oom-score) {#oom-score}
...
### [スコアの計算要素](#score-calculation-factors) {#score-calculation-factors}
...
詳細は [capability](../capability/) を参照してください

### [oom_score_adj による調整](#oom-score-adj-adjustment) {#oom-score-adj-adjustment}
...
### [重要なプロセスを保護する](#protecting-important-processes) {#protecting-important-processes}
...
## [OOM Killerの確認方法](#checking-oom-killer) {#checking-oom-killer}

### [dmesg で確認](#checking-with-dmesg) {#checking-with-dmesg}
...
### [/var/log/messages または journalctl](#var-log-or-journalctl) {#var-log-or-journalctl}
...
### [OOM のログの読み方](#reading-oom-logs) {#reading-oom-logs}
...
## [対策方法](#countermeasures) {#countermeasures}

### [1. メモリを増やす](#add-memory) {#add-memory}

最も単純な解決策です

物理メモリを増設するか、スワップを追加します

### [2. メモリリークを修正する](#fix-memory-leak) {#fix-memory-leak}
...
### [3. oom_score_adj を調整](#adjust-oom-score-adj) {#adjust-oom-score-adj}
...
### [4. Overcommitを制限](#limit-overcommit) {#limit-overcommit}
...
### [5. OOM Killerを無効化（非推奨）](#disable-oom-killer) {#disable-oom-killer}
...
## [cgroupとOOM](#cgroup-and-oom) {#cgroup-and-oom}

### [cgroup のメモリ制限](#cgroup-memory-limit) {#cgroup-memory-limit}
...
### [cgroup 内の OOM](#cgroup-oom) {#cgroup-oom}
...
### [コンテナと OOM](#container-and-oom) {#container-and-oom}
...
- [Memory Management - kernel.org](https://www.kernel.org/doc/html/latest/admin-guide/mm/){:target="\_blank"}
  - メモリ管理の概要
- [Control Group v2 - kernel.org](https://www.kernel.org/doc/html/latest/admin-guide/cgroup-v2.html){:target="\_blank"}
  - cgroup のメモリコントローラ
