---
layout: default
title: なぜメモリは4KB単位なのか
---

# [なぜメモリは4KB単位なのか](#why-4kb-memory-units) {#why-4kb-memory-units}

## [はじめに](#introduction) {#introduction}

[03-virtual-memory](../../03-virtual-memory/) の「ページングの仕組み」で、メモリは<strong>ページ</strong>という単位で管理されると学びました
...
- [ページとは何か](#what-is-page)
- [なぜ4KBなのか](#why-4kb)
- [ページテーブルの仕組み](#page-table-mechanism)
- [TLBとは](#what-is-tlb)
- [Huge Pages](#huge-pages)
- [ページサイズの確認方法](#checking-page-size)
- [まとめ](#summary)
- [参考資料](#references)

---

## [ページとは何か](#what-is-page) {#what-is-page}

### [メモリ管理の最小単位](#minimum-unit-of-memory-management) {#minimum-unit-of-memory-management}
...
## [なぜ4KBなのか](#why-4kb) {#why-4kb}

### [歴史的な経緯](#historical-background) {#historical-background}
...
### [4KBが選ばれた理由](#why-4kb-was-chosen) {#why-4kb-was-chosen}
...
### [2のべき乗である理由](#why-power-of-two) {#why-power-of-two}
...
## [ページテーブルの仕組み](#page-table-mechanism) {#page-table-mechanism}

### [なぜページテーブルが必要か](#why-page-table-needed) {#why-page-table-needed}

仮想アドレスを物理アドレスに変換するには、対応表が必要です

この対応表が<strong>ページテーブル</strong>です

### [単純なページテーブルの問題](#simple-page-table-problem) {#simple-page-table-problem}
...
### [多段ページテーブル](#multi-level-page-table) {#multi-level-page-table}
...
### [64ビット環境](#bit-environment) {#bit-environment}
...
## [TLBとは](#what-is-tlb) {#what-is-tlb}

### [なぜTLBが必要なのか](#why-tlb-needed) {#why-tlb-needed}
...
### [TLB（Translation Lookaside Buffer）](#tlb-translation-lookaside-buffer) {#tlb-translation-lookaside-buffer}
...
### [TLBの動作](#tlb-operation) {#tlb-operation}
...
### [TLBとページサイズの関係](#tlb-and-page-size-relationship) {#tlb-and-page-size-relationship}
...
## [Huge Pages](#huge-pages) {#huge-pages}

### [通常のページの限界](#limits-of-normal-pages) {#limits-of-normal-pages}
...
### [Huge Pages とは](#what-is-huge-pages) {#what-is-huge-pages}
...
### [Huge Pages の使い方](#how-to-use-huge-pages) {#how-to-use-huge-pages}
...
### [Huge Pages の確認と設定](#checking-and-configuring-huge-pages) {#checking-and-configuring-huge-pages}
...
### [コマンドラインで確認](#checking-via-command-line) {#checking-via-command-line}
...
### [C プログラムで確認](#checking-via-c-program) {#checking-via-c-program}
...
### [/proc から確認](#checking-via-proc) {#checking-via-proc}
...
- [Transparent Hugepage Support - kernel.org](https://www.kernel.org/doc/html/latest/admin-guide/mm/transhuge.html){:target="\_blank"}
  - THP の詳細
- [HugeTLB Pages - kernel.org](https://www.kernel.org/doc/html/latest/admin-guide/mm/hugetlbpage.html){:target="\_blank"}
  - Huge Pages の設定と使い方
