---
layout: default
title: /sysと/procは何が違うのか
---

# [/sysと/procは何が違うのか](#difference-between-sys-and-proc) {#difference-between-sys-and-proc}

## [はじめに](#introduction) {#introduction}

[01-kernel](../../01-kernel/) の「/sys ファイルシステム」で、`/sys` という疑似ファイルシステムがあることを学びました
...
- [歴史的な経緯](#historical-background)
- [設計思想の違い](#design-philosophy-difference)
- [/proc の特徴](#proc-characteristics)
- [/sys の特徴](#sys-characteristics)
...
### [/proc の誕生](#birth-of-proc) {#birth-of-proc}
...
### [/sys の登場](#emergence-of-sys) {#emergence-of-sys}
...
## [設計思想の違い](#design-philosophy-difference) {#design-philosophy-difference}

### [核心的な違い](#core-differences) {#core-differences}
...
### [「1ファイル1属性」の原則](#single-value-principle) {#single-value-principle}
...
### [得意なこと](#what-sys-is-good-at) {#what-sys-is-good-at}
...
### [/proc の主要なパス](#proc-main-paths) {#proc-main-paths}
...
## [/sys の特徴](#sys-characteristics) {#sys-characteristics}
...
### [/sys/class vs /sys/devices](#class-vs-devices) {#class-vs-devices}
...
### [/sys/class の例](#sys-class-examples) {#sys-class-examples}
...
cgroup の詳細は [07-cgroup](../../07-cgroup/) を参照してください

---

## [実用例](#practical-examples) {#practical-examples}

### [例1：ディスク情報の取得](#example-disk-info) {#example-disk-info}
...
### [例2：ネットワークインターフェース情報](#example-network-interface-info) {#example-network-interface-info}
...
### [例3：CPU 情報](#example-cpu-info) {#example-cpu-info}
...
- [The sysfs Filesystem - kernel.org](https://www.kernel.org/doc/html/latest/filesystems/sysfs.html){:target="\_blank"}
  - sysfs の公式ドキュメント
- [Rules on how to access information in sysfs](https://www.kernel.org/doc/html/latest/admin-guide/sysfs-rules.html){:target="\_blank"}
  - sysfs へのアクセスルール
